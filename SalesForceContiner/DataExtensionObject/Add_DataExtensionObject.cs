...
namespace UiPathTeam.Salesforce.Marketing_Cloud
{
    ...
    public class Add_DataExtensionObject : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        public Add_DataExtensionObject()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Add_DataExtensionObject>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
            Parameters = new List<ParametersArgument>();
            cmdTYPE = Type_of_Command.AddDataExtensionObject;
        }
