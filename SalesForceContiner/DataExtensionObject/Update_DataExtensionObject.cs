...
{
    [Description("Update an DataExtension from the Salesforce instance. You must provide DataExtension ID.")]
    public class Update_DataExtensionObject : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        [Category("Input")]
        [RequiredArgument]
        [Description("String DataExtension ID to be updated.")]
        public InArgument<String> DataExtensionID { get; set; }
        ...
        public Update_DataExtensionObject()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Update_DataExtensionObject>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
            Parameters = new List<ParametersArgument>();
            cmdTYPE = Type_of_Command.UpdateDataExtensionObject;
        }
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            String id = DataExtensionID.Get(context);
            ...
            var task = (new CmdRestAPI(salesForceProperty.AuthToken, salesForceProperty.ServiceURL, salesForceProperty.SoapClient, newDataTable, "DataExtension", id,"",cmdTYPE)).ExecuteAsync();
