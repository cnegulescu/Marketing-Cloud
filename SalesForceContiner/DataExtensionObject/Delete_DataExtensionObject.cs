...
namespace UiPathTeam.Salesforce.Marketing_Cloud
{
    ...
    public class Delete_DataExtensionObject : AsyncCodeActivity<CmdRestAPI>
    {
        public Delete_DataExtensionObject()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Delete_DataExtensionObject>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
        }
        ...
        [Category("Input")]
        [OverloadGroup("DataExtensionID")]
        [RequiredArgument]
        [Description("DataExtension ID to delete.")]
