...
{
    [Description("Get a list of items from the Salesforce instance using SOQL syntax. (Recommended for advance Salesforce developers)")]
    public class Get_Data : AsyncCodeActivity<CmdRestAPI>
    {
        public Get_Data()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Get_Data>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
        }
