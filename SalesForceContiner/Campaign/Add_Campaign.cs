...
{
    [Description("Add a new campaign to the Salesforce instance.")]
    public class Add_Campaign : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        [Category("Output")]
        [Description("String response CampaignID value.")]
        public OutArgument<string> CampaignID { get; set; }
        ...
        public Add_Campaign()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Add_Campaign>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
            Parameters = new List<ParametersArgument>();
            cmdTYPE = Type_of_Command.AddCampaign;
        }
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            var task = (new CmdRestAPI(salesForceProperty.AuthToken, salesForceProperty.ServiceURL, salesForceProperty.SoapClient, newDataTable, "campaigns", "","",cmdTYPE)).ExecuteAsync();
