...
{
    [Description("Get a list of DataExtension from the Salesforce instance.")]
    public class Get_DataExtension_List : AsyncCodeActivity<CmdRestAPI>
    {
        public Get_DataExtension_List()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Get_DataExtension_List>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
        }
