...
namespace UiPathTeam.Salesforce.Marketing_Cloud
{
    ...
    public class Update_DataExtension : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        [Category("Input")]
        [RequiredArgument]
        [Description("String DataExtension Name to be updated.")]
        ...
        public Update_DataExtension()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Update_DataExtension>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
            Parameters = new List<ParametersArgument>();
            cmdTYPE = Type_of_Command.UpdateDataExtension;
        }
