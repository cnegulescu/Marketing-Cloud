...
{
    [Description("Get a list of Opportunities from the Salesforce instance.")]
    public class Get_Subscriber_List : AsyncCodeActivity<CmdRestAPI>
    {
        public Get_Subscriber_List()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Get_Subscriber_List>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
        }
