...
{
    [Description("Add an new opportunity to Salesforce instance.")]
    public class Add_Subscriber : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Add_Subscriber>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
            Parameters = new List<ParametersArgument>();
            cmdTYPE = Type_of_Command.AddSubscriber;
        }
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            var task = (new CmdRestAPI(salesForceProperty.AuthToken, salesForceProperty.ServiceURL, salesForceProperty.SoapClient, newDataTable,"Keyword","","",cmdTYPE)).ExecuteAsync();
