...
{
    [Description("Update an opportunity from the Salesforce instance. You must provide Opportunity ID.")]
    public class Update_Subscriber : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            var task = (new CmdRestAPI(salesForceProperty.AuthToken, salesForceProperty.ServiceURL, salesForceProperty.SoapClient, newDataTable, "Keyword", id,"",cmdTYPE)).ExecuteAsync();
