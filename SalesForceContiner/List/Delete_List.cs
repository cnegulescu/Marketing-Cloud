...
{
    [Description("Delete an lead from the Salesforce instance. You must provide ListID")]
    public class Delete_List : AsyncCodeActivity<CmdRestAPI>
    {
        public Delete_List()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Delete_List>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
        }
