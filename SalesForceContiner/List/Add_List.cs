...
{
    [Description("Add a new list to the Salesforce instance.")]
    public class Add_List : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        [Category("Output")]
        [Description("String response ListID value.")]
        public OutArgument<string> ListID { get; set; }
