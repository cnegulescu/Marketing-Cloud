...
{
    [Description("Update an lead from the Salesforce instance. You must provide Lead ID.")]
    public class Update_List : AsyncCodeActivity<CmdRestAPI>
    {
        [Browsable(false)]
        ...
        [Category("Input")]
        [RequiredArgument]
        [Description("String List ID to be updated.")]
        ...
        public Update_List()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Update_List>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
            Parameters = new List<ParametersArgument>();
            cmdTYPE = Type_of_Command.UpdateList;
        }
