...
{
    [Description("Get a list of items from the Salesforce instance using a full wizard much easy to use business users.")]
    public class Get_Data_Wizard : AsyncCodeActivity<CmdRestAPI>
    {
        public Get_Data_Wizard()
        {
            Constraints.Add(CheckParentConstraint.GetCheckParentConstraint<Get_Data_Wizard>(typeof(Salesforce_Marketing_Cloud_Scope).Name));
        }
