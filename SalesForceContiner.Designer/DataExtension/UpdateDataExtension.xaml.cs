...
namespace UiPathTeam.Salesforce.Marketing_Cloud.Activities
{
    ...
    /// </summary>
    public partial class UpdateDataExtension
    {
        public UpdateDataExtension()
        {
            InitializeComponent();
        }
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            String ID2 = tmp.ConvertModelItem(ModelItem.Properties["DataExtensionName"].ComputedValue);
            if (ID2 == null) ID2 = "";
